...
import { ColumnType, User, TableType } from "../utils/Types";
import CloseIcon from "@rsuite/icons/Close";
import MoreIcon from "@rsuite/icons/More";
import { useAppSelector, useAppDispatch } from "../../redux/hooks";
import { selectUser } from "../../redux/user";
import { selectCurrentTable, setColumns } from "../../redux/currentTable";
import editSymbolWhite from "../../images/edit-symbol-white.svg"
import editSymbolDark from "../../images/edit-symbol.svg"
    ...
    <div className="flex item-center text-black w-4">
      <img
        className={`w-4 cursor-pointer ${
          currentTable._id === table._id ? "fill-white" : ""
        }`}
        src={
          currentTable._id === table._id
            ? editSymbolWhite
            : editSymbolDark
        }
